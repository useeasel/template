...
export interface DesignTokens {
  ...
  pages: { about: boolean; contact: boolean; cv: boolean; press: boolean; exhibitions: boolean; news: boolean; available: boolean; presskit: boolean; commissions: boolean; shop: boolean };
}
...
export function designClasses(d: DesignTokens): string {
  const pages = ['about', 'contact', 'cv', 'press', 'exhibitions', 'news', 'available', 'presskit', 'commissions', 'shop'] as const;
  return [
    `ez-nav-${d.nav.layout}`,
